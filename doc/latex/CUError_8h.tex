\hypertarget{CUError_8h}{\section{Référence du fichier lib/\-C\-Unit/\-C\-U\-Error.h}
\label{CUError_8h}\index{lib/\-C\-Unit/\-C\-U\-Error.\-h@{lib/\-C\-Unit/\-C\-U\-Error.\-h}}
}
...
\begin{DoxyCompactList}\small\item\em Sets the C\-Unit framework error code. \end{DoxyCompactList}\end{DoxyCompactItemize}


\subsection{Description détaillée}
Error handling functions (user interface). C\-Unit uses a simple (and conventional) error handling strategy. Functions that can generate errors set (and usually return) an error code to indicate the run status. The error code can be inspected using the \hyperlink{group__Framework_ga0bf3f9733e5fa0c0ed6ca0a37a2d995e}{C\-U\-\_\-get\-\_\-error()} function. A descriptive error message can be retrieved using \hyperlink{group__Framework_gaee27bf496da77437288bc9fe2a0b20ed}{C\-U\-\_\-get\-\_\-error\-\_\-msg()}. 