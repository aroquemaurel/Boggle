...
\begin{frame}{Présentation du sujet : Jeu de Boggle} % TODO qu'est ce qu'un jeu de boggle.
	\begin{itemize}
...
\begin{frame}{Les différentes versions} %% TODO expliquer les différentes versions
	...
	\end{block}
	\pause
	\begin{block}{Version 3 : Le mode NCurses}
		\begin{itemize}
			\item Jouer en utilisant la bibliothèque NCurses
			\item saisie à l'aide des flèches directionnels
...
\begin{frame}{Logiciel de versionnement : Git}
	\begin{itemize}
...
\begin{figure}[H]
	\vspace{20px}
	\includegraphics[width=4.9cm]{redmine.png}
...
\begin{frame}{Mode NCurses}
\end{frame}
\section*{}
\begin{frame}{Difficultés eu durant ce projet}
	\begin{itemize}
		\item Résolveur fiable, rapide et peu gourmand en RAM
			\pause
		\item Travail en binôme 
			\pause
		\item Apprentissage de la bibliothèque NCurses
	\end{itemize}
